To use THS on a stem bus, you will need to begin by instantiating YSFX at **the end** of the stem bus's insert slots. Then, open YSFX. By default, YSFX will look similar to the following:
